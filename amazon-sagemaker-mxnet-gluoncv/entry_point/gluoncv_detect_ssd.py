...
def train(gt_labeling_task, epochs, base_network, classes, learning_rate, wd, momentum, batch_size, num_workers, model_dir, train, labels,
          current_host, hosts): 
    """
    Transfer learning.
    """
    ...
    #define dataloader
    train_loader= get_dataloader(model, train_dataset, val_dataset, 512, 512, batch_size, num_workers)
...
if __name__ == '__main__':
    ...
    train(args.gt_labeling_task, args.epochs, args.base_network, args.classes, args.learning_rate, args.wd, args.momentum,
          args.batch_size, args.num_workers, args.model_dir, args.train, args.labels, args.current_host, args.hosts)
